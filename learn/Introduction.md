...
- **The Spider (Discovery Engine):** Uses a multi-strategy algorithm to discover highly active developers who might otherwise remain hidden. Our Spider uses weighted graph walks, temporal slicing, and network analysis—read more in [The Spider Guide](#/learn/data-factory/Engine).
...
For detailed information on how to permanently remove your profile from the index, please read our [Privacy & Opt-Out Guide](#/learn/OptOut).
