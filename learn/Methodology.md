...
We believe in presenting the raw, unfiltered truth of the GitHub API. Attempting to manually review and judge the validity of 50,000 profiles is impossible. Furthermore, as outlined in our [Data Scientists Guide](#/learn/personas/DataScientists), one user's "automation spam" is a researcher's valuable dataset on automation trends. Even using AI to randomly sample commits is just a snapshot—an account might have 50,000 incredibly valuable, organic contributions buried within millions of automated commits.
